...
def UNetPlusPlus(img_rows, img_cols, color_type=1, num_class=1, deep_supervision=False):
    ...
    up1_2 = (UpSampling2D((2, 2), name='up12',data_format=IMAGE_ORDERING))(conv2_1)
    up1_2 = (Conv2D(nb_filter[0], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up1_2)
    ...
    up2_2 = (UpSampling2D((2, 2), name='up22',data_format=IMAGE_ORDERING))(conv3_1)
    up2_2 = (Conv2D(nb_filter[1], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up2_2)

    conv2_2 = concatenate([up2_2, conv2_1], name='merge22', axis=bn_axis)
    conv2_2 = standard_unit(conv2_2, stage='22', nb_filter=nb_filter[1])

    #up1_3 = Conv2DTranspose(nb_filter[0], (2, 2), strides=(2, 2), name='up13', padding='same')(conv2_2)
    up1_3 = (UpSampling2D((2, 2), name='up13',data_format=IMAGE_ORDERING))(conv2_2)
    up1_3 = (Conv2D(nb_filter[1], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up1_3)
    ...
    up3_2 = (UpSampling2D((2, 2), name='up32',data_format=IMAGE_ORDERING))(conv4_1)
    up3_2 = (Conv2D(nb_filter[1], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up3_2)

    conv3_2 = concatenate([up3_2, conv3_1], name='merge32', axis=bn_axis)
    conv3_2 = standard_unit(conv3_2, stage='32', nb_filter=nb_filter[2])

    #up2_3 = Conv2DTranspose(nb_filter[1], (2, 2), strides=(2, 2), name='up23', padding='same')(conv3_2)
    up2_3 = (UpSampling2D((2, 2), name='up23',data_format=IMAGE_ORDERING))(conv3_2)
    up2_3 = (Conv2D(nb_filter[1], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up2_3)

    conv2_3 = concatenate([up2_3, conv2_1, conv2_2], name='merge23', axis=bn_axis)
    conv2_3 = standard_unit(conv2_3, stage='23', nb_filter=nb_filter[1])

    #up1_4 = Conv2DTranspose(nb_filter[0], (2, 2), strides=(2, 2), name='up14', padding='same')(conv2_3)
    up1_4 = (UpSampling2D((2, 2), name='up14',data_format=IMAGE_ORDERING))(conv2_3)
    up1_4 = (Conv2D(nb_filter[1], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up1_4)
    ...
    #up4_2 = Conv2DTranspose(nb_filter[3], (2, 2), strides=(2, 2), name='up42', padding='same')(conv5_1)
    up4_2 = (UpSampling2D((2, 2), name='up42',data_format=IMAGE_ORDERING))(conv5_1)
    up4_2 = (Conv2D(nb_filter[1], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up4_2)

    conv4_2 = concatenate([up4_2, conv4_1], name='merge42', axis=bn_axis)
    conv4_2 = standard_unit(conv4_2, stage='42', nb_filter=nb_filter[3])

    #up3_3 = Conv2DTranspose(nb_filter[2], (2, 2), strides=(2, 2), name='up33', padding='same')(conv4_2)
    up3_3 = (UpSampling2D((2, 2), name='up33',data_format=IMAGE_ORDERING))(conv4_2)
    up3_3 = (Conv2D(nb_filter[1], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up3_3)

    conv3_3 = concatenate([up3_3, conv3_1, conv3_2], name='merge33', axis=bn_axis)
    conv3_3 = standard_unit(conv3_3, stage='33', nb_filter=nb_filter[2])

    #up2_4 = Conv2DTranspose(nb_filter[1], (2, 2), strides=(2, 2), name='up24', padding='same')(conv3_3)
    up2_4 = (UpSampling2D((2, 2), name='up24',data_format=IMAGE_ORDERING))(conv3_3)
    up2_4 = (Conv2D(nb_filter[1], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up2_4)

    conv2_4 = concatenate([up2_4, conv2_1, conv2_2, conv2_3], name='merge24', axis=bn_axis)
    conv2_4 = standard_unit(conv2_4, stage='24', nb_filter=nb_filter[1])

    #up1_5 = Conv2DTranspose(nb_filter[0], (2, 2), strides=(2, 2), name='up15', padding='same')(conv2_4)
    up1_5 = (UpSampling2D((2, 2), name='up15',data_format=IMAGE_ORDERING))(conv2_4)
    up1_5 = (Conv2D(nb_filter[1], (3, 3), activation='relu', padding='same', kernel_regularizer=l2(1e-4)))(up1_5)
