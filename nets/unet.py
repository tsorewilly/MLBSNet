...
def _segnet(n_classes, encoder, input_height=416, input_width=416, encoder_level=3,deploy=True,aux_branch=True):
    # encoder通过主干网络
    ...
    o = zheng_decoder(feat, n_classes)
...
def convnet_unet(n_classes, input_height=224, input_width=224, encoder_level=3,deploy=False,aux_branch=True):
    model = _segnet(n_classes, Xception, input_height=input_height, input_width=input_width,
